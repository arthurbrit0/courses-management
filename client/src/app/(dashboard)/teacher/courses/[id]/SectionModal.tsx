...
const SectionModal = () => {
  ...
  const onSubmit = (data: SectionFormData) => {
    ...
    toast.success(
        `Seção ${selectedSectionIndex === null ? "adicionado" : "editado"} com sucesso! Salve-o para manter as alterações.`
    )
    ...
    <CustomModal isOpen={isSectionModalOpen} onClose={onClose}>
        <div className="section-modal">
            <div className="section-modal__header">
                <h2 className="section-modal__title">Adicionar/Editar capítulo</h2>
